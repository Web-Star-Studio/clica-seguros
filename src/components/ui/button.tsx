  ...
  'inline-flex items-center justify-center font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 select-none',
  {
    variants: {
      variant: {
        ...
        outline: 'bg-transparent text-neutral-charcoal hover:bg-neutral-charcoal hover:text-white focus-visible:ring-neutral-charcoal',
        ...
        brand: 'bg-primary text-white hover:bg-primary/90 focus-visible:ring-primary shadow-md hover:shadow-lg uppercase tracking-[0.05em]',
      },
      size: {
