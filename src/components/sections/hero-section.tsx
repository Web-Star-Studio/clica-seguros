...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100vh] overflow-hidden">
      ...
      <div className="app-container relative z-10 flex min-h-[100vh] items-center py-20">
        <div className="grid w-full grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <div className="relative lg:col-span-5">
            ...
            >
              <motion.div 
                className="cursor-pointer rounded-2xl bg-primary p-6 text-white shadow-2xl transition-all hover:scale-105"
                whileHover={{ rotate: 2 }}
              >
